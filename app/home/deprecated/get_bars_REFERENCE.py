...
#     posted_data = event['body']
    
#     if posted_data['authorization'] != '1c9052e6-1eg4-4d68-98a2-2bff5f2ec095':
#         return {
#            'statusCode': 401,
#            'body': 'unauthorized'
#         }

#     information_to_collect = posted_data['tokens']
    
#     results = getDetails(information_to_collect)
